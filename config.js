...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'SMILEY;➕𝖜𝖆𝖑𝖊🧸;2347012656933;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'SMILEY;➕𝖜𝖆𝖑𝖊🧸;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'SMILEY;➕𝖜𝖆𝖑𝖊🧸' : process.env.STICKER_DATA,
